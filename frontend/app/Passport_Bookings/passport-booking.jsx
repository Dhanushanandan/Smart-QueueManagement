...
import { COLORS, styles } from "../../styles/passport-booking.styles";
  ...
  <View style={styles.serviceContainer}>
    <View style={styles.serviceHeader}>
      ...
      <Text style={styles.serviceSubtitle}>
        Select the passport service you need
      </Text>
    </View>
    ...
    >
      ...
      <View style={styles.serviceContent}>
        ...
        <Text style={styles.serviceDescription}>
          Apply for your first Sri Lankan passport
        </Text>
    ...
    >
      ...
      <View style={styles.serviceContent}>
        ...
        <Text style={styles.serviceDescription}>
          Renew your existing or expired passport
        </Text>
        <View style={styles.serviceBadge}>
          <Ionicons
    ...
    >
      ...
      <View style={styles.serviceContent}>
        ...
        <Text style={styles.serviceDescription}>
          Replace lost, damaged, or stolen passport
        </Text>
        <View style={styles.serviceBadge}>
          <Ionicons
            name="alert-circle-outline"
    ...
    >
      ...
      <View style={styles.serviceContent}>
        ...
        <Text style={styles.serviceDescription}>
          Update information in existing passport
        </Text>
        <View style={styles.serviceBadge}>
          <Ionicons
...
export default function PassportBooking() {
  ...
  const loadTempData = async () => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/passport-booking/temp-data/${userId}`,
      );
  ...
  const loadRecommendedSlot = async () => {
    try {
      const response = await fetch(
        `${API_BASE_URL}/passport-booking/recommended-slot/${userId}`,
      );
      const result = await response.json();
      if (result.success && result.data) {
  ...
  const loadAvailableSlots = async () => {
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/passport-booking/available-slots?date=${targetDate}`,
      );
      const result = await response.json();
    ...
    Alert.alert(
      ...
      [
        ...
        },
        {
          ...
          onPress: () => uploadDocumentWithPicker("marriage_certificate"),
        },
        {
          text: "📄 Other Document",
  ...
  const saveStep1 = async () => {
    ...
    if (age < 16) {
      Alert.alert(
        "Validation Error",
        `Applicant must be at least 16 years old for passport`,
      );
      return false;
    }
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/passport-booking/save-personal/${userId}`,
        {
          method: "POST",
  ...
  const saveStep2 = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/passport-booking/save-identity/${userId}`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(payload),
  ...
  const saveStep3 = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/passport-booking/save-family/${userId}`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(payload),
  ...
  const saveStep4 = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/passport-booking/save-passport-details/${userId}`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify(payload),
  ...
  const submit = async () => {
    ...
    try {
      ...
      const response = await fetch(
        `${API_BASE_URL}/passport-booking/confirm/${userId}`,
        {
          method: "POST",
          headers: { "Content-Type": "application/json" },
          body: JSON.stringify({
  ...
  const getServiceTitle = () => {
    switch (serviceType) {
      ...
      case "lost":
        return "Lost/Damaged Passport";
      case "amendment":
        return "Passport Amendment";
      default:
              ...
              <View style={styles.formSection}>
                ...
                {serviceType !== "new" && (
                  <>
                    ...
                    <SelectInput
                      label="Do you have previous passport?"
                      value={form.previousPassport}
                      onChange={(t) => updateField("previousPassport", t)}
                      options={["Yes", "No"]}
                      required
                    />
                    {form.previousPassport === "Yes" && (
                      <>
                        <Input
                          ...
                          value={form.previousPassportNo}
                          onChangeText={(t) =>
                            updateField("previousPassportNo", t)
                          }
                          required
                          focusedField={focusedField}
                          setFocusedField={setFocusedField}
            ...
            <View style={styles.card}>
              <View style={styles.cardHeader}>
                ...
                <View style={styles.cardHeaderText}>
                  ...
                  <Text style={styles.sectionSubtext}>
                    Enter your family and address details
                  </Text>
                </View>
              </View>
              <View style={styles.formSection}>
                ...
                <Input
                  ...
                  onChangeText={(t) => updateField("spouseName", t)}
                  focusedField={focusedField}
                  setFocusedField={setFocusedField}
                />
          ...
          {step === 4 && (
            <View style={styles.card}>
              <View style={styles.cardHeader}>
                ...
                <View style={styles.cardHeaderText}>
                  <Text style={styles.section}>
                    Passport & Emergency Details
                  </Text>
                  <Text style={styles.sectionSubtext}>
                    Select passport type and emergency contact
                  </Text>
                </View>
              </View>
              <View style={styles.formSection}>
                ...
                <SelectInput
                  ...
                  onChange={(t) => updateField("passportType", t)}
                ...
                <SelectInput
                  ...
                  onChange={(t) => updateField("validityPeriod", t)}
                ...
                <SelectInput
                  ...
                  value={form.pages}
                  onChange={(t) => updateField("pages", t)}
                ...
                <Input
                  ...
                  onChangeText={(t) =>
                    updateField("educationalQualification", t)
                  }
                  focusedField={focusedField}
                  setFocusedField={setFocusedField}
                />
              ...
              <View style={styles.formSection}>
                  ...
                  >
                    ...
                    <View style={styles.uploadContent}>
                      ...
                      <Text style={styles.uploadSubtext}>
                        NIC, Birth Certificate, Photos (required)
                      </Text>
                    </View>
                    <Ionicons
                ...
                <View style={styles.reviewCard}>
                  ...
                  <View style={styles.reviewSection}>
                    ...
                    {[
                      ["Passport Type", form.passportType],
